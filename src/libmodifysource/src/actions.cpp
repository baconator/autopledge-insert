...
namespace autopledge {
    ExampleVisitor::ExampleVisitor(clang::CompilerInstance *CI)
    ...
    ExampleASTConsumer::ExampleASTConsumer(clang::CompilerInstance *CI) : visitor(new ExampleVisitor(CI)) { }
    ...
    std::unique_ptr<clang::ASTConsumer> ExampleFrontendAction::CreateASTConsumer(clang::CompilerInstance& CI,
        ...
        return std::make_unique<autopledge::ExampleASTConsumer>(&CI); // pass CI pointer to ASTConsumer
    }
}